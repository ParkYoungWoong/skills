...
외부 URL(`https://...`)이 제공된 경우 서버 감지 없이 바로 사용한다.

### 2단계: Lighthouse 실행 환경 확인
...
분석 완료 후 생성된 리포트 디렉토리를 삭제하여 프로젝트 디렉토리를 깨끗하게 유지한다.
